...
public class RedisConfig implements CachingConfigurer {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory factory, ObjectMapper springObjectMapper) {
        ...
        cacheConfigs.put("mentor",         defaultConfig.entryTtl(Duration.ofMinutes(10)));
        cacheConfigs.put("mentors",        defaultConfig.entryTtl(Duration.ofMinutes(5)));
        cacheConfigs.put("mentorSearch",   defaultConfig.entryTtl(Duration.ofMinutes(5)));
